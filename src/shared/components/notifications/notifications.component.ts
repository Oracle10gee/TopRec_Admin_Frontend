            ...
            <div
                *ngFor="let notification of notifications"
                [ngClass]="{
                    ...
                    'bg-yellow-50 border-l-4 border-yellow-500 text-yellow-800': notification.type === 'warning',
                    'bg-blue-50 border-l-4 border-blue-500 text-blue-800': notification.type === 'info'
                }"
                class="px-4 py-3 rounded-lg shadow-lg animate-slideIn pointer-events-auto flex items-start gap-3 min-w-80"
            >
                <!-- Icon -->
