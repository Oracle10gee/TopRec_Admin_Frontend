...
export class DashboardLicenseComponent implements OnInit, OnDestroy {
     ...
     * The QR encodes the FRONTEND /verify/:userId page, not the raw API
     * endpoint, so scanners land on the human-readable verification page.
     * window.location.origin resolves to the real production domain at
     * runtime — never localhost once the app is deployed.
     */
