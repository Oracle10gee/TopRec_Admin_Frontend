...
export class AuthService {
     ...
     * PATCH /payments/payment-types/:id/toggle
     */
    togglePaymentTypeStatus(paymentTypeId: string): Observable<any> {
        return this.apiService.patch(`/payments/payment-types/${paymentTypeId}/toggle`, {}).pipe(
            catchError((error) => {
